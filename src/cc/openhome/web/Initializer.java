...
import cc.openhome.model.PhotoDAO;
import cc.openhome.model.PhotoDAOJdbcImpl;
...
public class Initializer implements ServletContextListener {
    public void contextInitialized(ServletContextEvent sce) {
        ...
        PhotoDAO photoDAO = new PhotoDAOJdbcImpl(dataSource);
        MessageDAO messageDAO = new MessageDAOJdbcImpl(dataSource);
        context.setAttribute("userService", new UserService(acctDAO, photoDAO, messageDAO));
    ...
    private DataSource dataSource() {
        try {
           ...
           return (DataSource) envContext.lookup("jdbc/photo");
